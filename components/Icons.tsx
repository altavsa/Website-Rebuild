...
export function IconCamera({ className = "h-8 w-8" }: IconProps) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
...
export function IconFingerprint({ className = "h-8 w-8" }: IconProps) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
      ...
      aria-hidden="true"
    >
      <path d="M12 11c0 2.5-1 4.5-2.5 6" />
      <path d="M12 7a5 5 0 0 1 5 5c0 3-1.5 5.5-3.5 7.5" />
      <path d="M12 3a9 9 0 0 1 9 9c0 4.5-2 8-5 10.5" />
      <path d="M12 11c0 2.5 1 4.5 2.5 6" />
      <path d="M7 11a5 5 0 0 1 1.5-3.5" />
      <path d="M5 20.5C3.5 18.5 2.5 15.5 2.5 12A9.5 9.5 0 0 1 8 3.5" />
    </svg>
  );
}

export function IconMonitor({ className = "h-8 w-8" }: IconProps) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
